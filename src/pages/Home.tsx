...
import { ArrowRight, Award, Building2, Users, CheckCircle2, TrendingUp, Hammer, Construction, Factory, Wrench, Target, Eye, Shield } from "lucide-react";
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-primary-foreground relative z-10 animate-fade-in">
          <Badge className="mb-6 bg-accent text-accent-foreground hover:bg-accent/90 animate-slide-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-accent text-accent-foreground hover:bg-accent/90 hover:scale-105 transition-all duration-300 shadow-hover">
              <Link to="/contact">
                Request Proposal <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="bg-card/10 backdrop-blur-sm border-primary-foreground/30 text-primary-foreground hover:bg-card/20 hover:scale-105 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              <Card 
                key={index} 
                className="text-center hover:shadow-hover hover:-translate-y-2 transition-all duration-300 border-primary/10 animate-fade-in"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              <Badge className="mb-4 bg-primary/10 text-primary hover:bg-primary/20">About Techneqatar</Badge>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <Card 
                key={index} 
                className="group hover:shadow-hover hover:-translate-y-2 transition-all duration-300 border-primary/10 overflow-hidden animate-fade-in"
                style={{ animationDelay: `${index * 100}ms` }}
              >
                <CardHeader>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            {featuredProjects.map((project, index) => (
              <Card 
                key={index} 
                className="overflow-hidden hover:shadow-hover transition-all duration-300 group border-primary/10 animate-fade-in"
                style={{ animationDelay: `${index * 100}ms` }}
              >
          ...
          <div className="text-center mt-12">
            <Button asChild size="lg" className="hover:scale-105 transition-all duration-300 shadow-hover">
              <Link to="/projects">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {certifications.map((cert, index) => (
              <Card 
                key={index} 
                className="hover:shadow-hover hover:-translate-y-1 transition-all duration-300 border-accent/20 animate-fade-in"
      ...
      <section className="py-24 bg-gradient-to-br from-primary via-primary to-secondary text-primary-foreground relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 animate-fade-in">
          <h2 className="text-3xl xl:text-5xl font-bold mb-6">Ready to Start Your Project?</h2>
          <p className="text-lg xl:text-xl mb-10 opacity-95 max-w-2xl mx-auto">
