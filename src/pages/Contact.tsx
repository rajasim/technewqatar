...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: "Phone Number",
      details: ["+974 770200829", "+974 7713 7003"],
    },
    {
      icon: Mail,
      title: "Email Address",
      details: ["info@technewqatar.com", "projects@technewqatar.com"],
    },
    {
      icon: Clock,
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h1 className="text-4xl xl:text-5xl font-bold mb-6">Contact Technewqatar</h1>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardContent className="p-8">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  We work with Qatar Development entities, Semi-Development Authorities, and Large Corporates on 
